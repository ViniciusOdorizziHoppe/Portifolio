  ...
  return (
    <section id="contato" className="border-t border-vercel-border mx-auto max-w-[1200px] px-6 py-20 bg-white">
      ...
      <div className="mx-auto max-w-xl">
        ...
        <a
          href="https://wa.me/5547997615032?text=Ol%C3%A1%20Vin%C3%ADcius%2C%20vim%20pelo%20seu%20site%20e%20gostaria%20de%20conversar%20sobre%20um%20projeto."
          target="_blank"
          rel="noopener noreferrer"
          className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#25D366] px-6 py-3 text-sm font-medium text-white transition-all hover:bg-[#1fb855]"
        >
        ...
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center"><span className="w-full border-t border-vercel-border" /></div>
          <div className="relative flex justify-center text-xs"><span className="bg-white px-2 text-vercel-muted">ou preencha o formulário</span></div>
        </div>
